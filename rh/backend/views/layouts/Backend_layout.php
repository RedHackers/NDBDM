    ...
    <aside id="sidebar_left" class="nano nano-light affix">
      ...
      <div class="sidebar-left-content nano-content">
        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo Url::to(['site/personalworkli']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 李想</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['site/personalworkcui']) ?>">
                  <span class="glyphicon glyphicon-book"></span>崔立骁</a>
              </li>
               <li>
                <a href="<?php echo Url::to(['site/personalworkjia']) ?>">
                  <span class="glyphicon glyphicon-book"></span>贾靖宇</a>
              </li>
               <li>
                <a href="<?php echo Url::to(['site/personalworkzhou']) ?>">
      ...
      <li class="sidebar-label pt15">信息修改</li>
          <li>
            ...
            <ul class="nav sub-nav">
                <li>
                <a href="<?php echo Url::to(['rh-team-info/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span>RhTeamInfo</a>
              </li>
             <li>
                <a href="<?php echo Url::to(['rh-team-server/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span>RhTeamService</a>
              </li>       
            </ul>
          </li>
       ...
       <!-- -->
          <li>
            ...
            <ul class="nav sub-nav">
             <li>
                <a href="<?php echo Url::to(['rh-member-info/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span>RhMemberInfo</a>
              </li>
             <li>
                <a href="<?php echo Url::to(['rh-member-live/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span>RhMemberLive</a>
              </li>
            </ul>
          </li>
         ...
         <!-- -->
          <li>
            ...
            <ul class="nav sub-nav">
             <li>
                <a href="<?php echo Url::to(['rh-activity-info/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span>RhActivityInfo</a>
              </li>

             <li>
                <a href="<?php echo Url::to(['rh-activity-attend/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span>RhActivityAttend</a>
              </li>

              <li>
                <a href="<?php echo Url::to(['rh-activity-show/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span>RhActivityShow</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul class="nav sub-nav">
             <li>
                <a href="<?php echo Url::to(['rh-note-record/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span>RhNoteRecord</a>
              </li>

             <li>
                <a href="<?php echo Url::to(['rh-note-show/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span>RhNoteShow</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul class="nav sub-nav">
             <li>
                <a href="<?php echo Url::to(['rh-info-link/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> link</a>
              </li>
            </ul>
          </li>
           <li class="sidebar-label pt20">友情链接</li>
                <li class="sidebar-proj">
                    <a href="https://www.baidu.com/ 

">
                        <span class="fa fa-dot-circle-o text-primary"></span>
                        <span class="sidebar-title">百度首页</span>
                    </a>
                </li>
                <li class="sidebar-proj">
...
">
                        ...
                        <span class="sidebar-title">南开大学</span>
                    </a>
                </li>
                <li class="sidebar-proj">
                    <a href="http://cc.nankai.edu.cn/ 

">
                        <span class="fa fa-dot-circle-o text-danger"></span>
                        <span class="sidebar-title">计控学院</span>
                    </a>
                </li>
