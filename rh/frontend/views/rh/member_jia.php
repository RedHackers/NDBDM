			...
			<div class="w3l-banner-grids">
				...
				<div class="col-md-4 w3ls-banner-left">
					<div class="w3ls-banner-left-info">
						<h3 class="name">贾靖宇</h3>
					</div>
					<div class="w3ls-banner-left-info">
						<h4>专业</h4>
						<p>
							<?= RhMemberInfo::find()->where(['member_name' => '贾靖宇', ])->one()->member_major; ?>
						</p>
					</div>
					<div class="w3ls-banner-left-info">
						<h4>学历</h4>
						<p>
							<?= RhMemberInfo::find()->where(['member_name' => '贾靖宇', ])->one()->member_degree; ?>
						</p>
					</div>
					<div class="w3ls-banner-left-info">
						<h4>职务</h4>
						<p>
							<?= RhMemberInfo::find()->where(['member_name' => '贾靖宇', ])->one()->member_duty; ?>
						</p>
					</div>
					<div class="w3ls-banner-left-info">
						<h4>邮箱</h4>
						<p><a href= <?= RhMemberInfo::find()->where(['member_name' => '贾靖宇', ])->one()->member_email; ?>>
							<?= RhMemberInfo::find()->where(['member_name' => '贾靖宇', ])->one()->member_email; ?>
						</a></p>
					</div>
				</div>
				<div class="clearfix"> </div>
