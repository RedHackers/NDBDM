...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-07-10 12:14:58
...
('密码学竞赛', '“没有网络安全就没有国家安全”，密码是保障网络空间和信息安全的核心技术。为进一步提高我国高校学生的信息安全意识，普及密码知识，实践密码技术，发现密码人才，鼓励创新思维，增进团队协作，推动我国密码技术的发展和应用，中国密码学会定于2017年9月至11月举办第三届全国密码技术竞赛（含初赛、复赛、决赛三个阶段）。', '密码学竞赛.jpg', 1),
('信息安全大赛', '2017年第十届全国大学生信息安全竞赛由教育部高等学校信息安全专业教学指导委员会主办，由西安电子科技大学承办。本次竞赛的目的，是为培养、选拔、推荐优秀信息安全专业人才创造条件，促进高等学校信息安全专业课程体系、教学内容和方法的改革，培养学生的创新意识与团队合作精神，普及信息安全知识，增强学生信息安全意识。', '信息安全大赛.jpg', 2),
('篮球比赛', '篮球比赛即根据篮球运动进行的比赛，篮球比赛的形式多种多样，有较为常见的五人篮球，也有最流行的街头三人篮球赛，是三对三的比赛，更讲究个人技术。', '篮球比赛.jpg', 3),
('排球比赛', '排球比赛是两队在由球网分开的场地上进行比赛的集体项目。它可以有多种比赛方式，以适应各种不同性质比赛的需求，从而不断推动该项运动的广泛开展。 \n比赛的目的，是各队遵照规则，将球击过球网，使其落在对方场区的地面上，而防止球落在本方场区的地面上。每队可击球3次(拦网触球除外)将球击回对区。', '排球比赛.jpg', 4),
('图书馆志愿者活动', '为了培养志愿者们的服务热情和对志愿工作的态度，体验图书馆工作人员的辛苦，从而使他们能自觉遵守图书馆的有关规定，懂得珍惜图书馆工作人员的劳动成果，同时把爱心传递给周围的人，影响并带动更多的人奉献爱心，让志愿者们体会生活的不易，更好的充实自己。', '图书馆志愿者活动.jpg', 5),
('马拉松志愿者活动', '参与这项活动能让我们学会树立大局意识、服务意识和学习意识；并且感受到责任 的意义，；我们在参与的过程中能全身心的投入、坚守岗位，以高质量的志愿服务水平为赛事添加光彩。', '马拉松志愿者活动.jpg', 6);
...
--
ALTER TABLE `rh_note_record`
  MODIFY `note_id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '留言id', AUTO_INCREMENT=9;
--
